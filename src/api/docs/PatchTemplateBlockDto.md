...
**placeholderTitle** | **string** |  | [optional] [default to undefined]
**placeholderBody** | **string** |  | [optional] [default to undefined]

## Example

```typescript
import { PatchTemplateBlockDto } from './api';

const instance: PatchTemplateBlockDto = {
    order,
    headingLevel,
    calloutVariant,
    galleryLayout,
